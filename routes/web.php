...
Route::post('/translation/{set_id}/{translation_id}/delete', [\App\Http\Controllers\TranslationsController::class, 'delete'])->name('translation.delete');
Route::post('/translation/{set_id}/{translation_id?}/update', [\App\Http\Controllers\TranslationsController::class, 'update'])->name('translation.update');
